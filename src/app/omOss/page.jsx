    ...
    return (
        <div>
            ...
            <div className="aboutPageWrapper navPage">
                <div>
                    <h1>Eskilstuna Trafikskola i Katrineholm</h1>
                    <br />
                    ...
                    <br />
                    <p>Vi på <span>Eskilstuna Trafikskola</span> AB utbildar bara inom behörighet B-körkort. För oss är anpassbarhet i körkortsutbildning en viktig grund för goda resultat.</p>
                    <br />
                    ...
                    <br />
                    <p>Vi arbetar efter en given undervisningsplan. Kontakta oss på <span>Eskilstuna Trafikskola</span>, så kan vi tillsammans kolla på hur just du ska göra för att nå målet med körkortet.</p>
                    <br />
                    ...
                    <br />
                    <h3 style={{ fontWeight: 'bold' }}>Vi har två lokaler, huvudlokal i Eskilstuna och andra lokal i Katrineholm</h3>
